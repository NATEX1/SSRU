        ...
        <div className="flex flex-col lg:flex-row items-start gap-4">
          <div className="flex-1 min-w-0">
                  ...
                  <div key={i} className="flex flex-col min-w-0">
                    ...
                    <div className="card overflow-hidden w-full min-w-0">
                      ...
                      <div className="card-body p-2 sm:p-3 min-w-0">
                        <h2 className="card-title line-clamp-1 break-words min-w-0">
                          {post.title}
                        </h2>

                        <p className="line-clamp-2 break-words text-sm min-w-0">
                          {post.excerpt}
                        </p>
            ...
            <div className="flex flex-col lg:flex-row gap-8 flex-1 mb-8">
              <div className="w-full lg:max-w-[563px] min-w-0 bg-[#F9FAFB] py-10 lg:py-16 px-5 lg:px-8 rounded-4xl">
          ...
          <div className="hidden lg:block sticky top-20 pt-2 w-[362px] space-y-8">
            ...
            <div>
              ...
              <ul className="space-y-4">
                {archiveCategories.map((item) => (
                  <li key={item.href}>
                    <h6>
                      <a href={item.href} className="hover:text-[#F06FAA] transition">
                        {item.category}
                      </a>
                    </h6>
                  </li>
