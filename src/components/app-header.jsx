      ...
      <div className="relative container mx-auto h-20 px-4 flex items-center justify-between">
        ...
        <div className="lg:hidden flex items-center">
          <button
            ...
            className={`p-2 rounded-full border border-[#F3F4F6] bg-white hover:bg-gray-50 transition
        ...
        <div
          className={`flex items-center gap-3 ml-auto transition-opacity duration-200
        ...
        {/* Mobile Search Input (แถวเดียวใน header) */}
        <div
